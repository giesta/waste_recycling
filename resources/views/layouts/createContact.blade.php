...
<div id="content">
  <div id="contentLeft">
    ...
    Laikas: {{session('time')}}</p>
      ...
      <h1 class="align">Pridėti naują darbuotoją</h1>
        <div class="row">
            <div class="col-md-12 col-md-offset-3">
                <div class="panel panel-default">
                    <div class="panel-body">
                        <form class="form-horizontal" role="form" method="POST" action="{{ route('insertUser') }}">
                            ...
                            <div class="form-group">
                                <label class="col-md-4 control-label">Pavarde</label>
                                <div class="col-75">
